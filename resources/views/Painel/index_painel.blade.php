...
<head>
    ...
    <link href="{{ asset('libs/bootstrap/css/price-range.css') }}" rel="stylesheet">
    <link href="{{ asset('libs/bootstrap/css/animate.css') }}" rel="stylesheet">
...
<body>
                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="index.html"><img class="logoInicial" src="img/logoSupripack.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="/inicial/carrinho"><i class="fa fa-shopping-cart"></i>Cart <span
                                            class="badge badge-danger countProd"></span></a></li>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="/inicial/carrinho">Cart </a></li>
    ...
    <footer id="footer">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span style="color:#21337e">e</span>-SUPRIPACK</h2>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2020 Supripack Inc. All rights reserved.</p>
    ...
    <script src="{{ asset('libs/bootstrap/js/jquery.js') }}"></script>
    <script src="{{ asset('libs/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('libs/bootstrap/js/jquery.scrollUp.min.js') }}"></script>
